    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 bg-[#D3F1DF] px-4 lg:px-8">
            <div class="mx-auto flex w-full flex-col justify-center min-h-screen max-w-[350px] space-y-6">
                ...
                <form action="/authlouis/signupProcess" method="post" class="space-y-4">
                    <div class="space-y-2">
                        <label for="name" class="text-sm font-medium text-[#525B44]">Username</label>
                        <input 
                            type="text" 
                            id="name" 
                            name="name" 
                ...
                <p class="text-center text-sm text-[#5A6C57]">
                    ...
                    <a href="/authlouis/login" class="underline hover:text-[#525B44] font-medium">
                        Login
                    </a>
                </p>
            </div>
